"use client";
// components/AttackReplay.jsx
//
// Drop into: components/AttackReplay.jsx
// Usage: <AttackReplay />
// Add to shield/page.jsx after the Hero section and before the GAP section
//
// Displays a cinematic terminal replay of 4 real AEGIS threat scenarios.
// All field names, query patterns, and anomaly signatures match AEGIS Shield detection categories.
// Scenarios: Credential Misuse (T1078/T1530), Slow Exfiltration (T1020/T1041),
//            Schema Recon (T1213/T1074), Data Poisoning (T1565/T1491)
...
const RISK_COLORS = (v) =>
  v < 40 ? "#34d399" : v < 70 ? "#f59e0b" : "#ff4444";
    ...
    >
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "2.5rem" }}>
          <div style={{ fontSize: "0.68rem", letterSpacing: "0.2em", color: ACCENT, opacity: 0.7, marginBottom: "0.75rem" }}>
            LIVE DETECTION REPLAY
          </div>
          <h2
            style={{
          ...
          <p style={{ color: "#5a7a8a", fontSize: "0.9rem", lineHeight: 1.6, maxWidth: "580px" }}>
            Each scenario replays a real attack pattern using the field names, query structures, and
            behavioral signals AEGIS Shield detects in production environments.
          </p>
        </div>
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <span style={{ fontSize: "11px", color: "#3a5a70", letterSpacing: "0.08em" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <div
                style={{
                  ...
                  height: "6px",
                  borderRadius: "50%",
                  background: detected ? "#ff4444" : running ? "#34d399" : "#34d399",
                  animation: running && !detected ? "pulse-d 1.5s infinite" : "none",
                }}
              />
              <span
                style={{
          ...
          >
            {SCENARIOS.map((sc, i) => (
              <button
                ...
                disabled={running && i !== scenarioIdx}
                style={{
                  padding: "4px 12px",
                  fontSize: "10px",
                  ...
                  background: i === scenarioIdx ? "rgba(0,212,255,0.06)" : "transparent",
                  color: i === scenarioIdx ? "#00d4ff" : "#4a6a80",
                  cursor: "pointer",
                  fontFamily: "inherit",
                  transition: "all 0.15s",
                  opacity: running && i !== scenarioIdx ? 0.4 : 1,
                }}
              >
            ...
            {lines.map((line) => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{ color: MSG_COLORS[line.tag] || "#8090a0", flex: 1, wordBreak: "break-all" }}>
                    {line.msg}
                  </span>
                </div>
              );
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "14px", flex: 1 }}>
              <span style={{ fontSize: "10px", color: "#2a4a5a", letterSpacing: "0.08em", flexShrink: 0 }}>
                RISK SCORE
              </span>
              <div
                style={{
              ...
              <span style={{ fontSize: "12px", fontWeight: 700, color: riskColor, minWidth: "28px" }}>
                {riskScore}
              </span>
              <span style={{ fontSize: "10px", color: "#2a4a5a", letterSpacing: "0.06em" }}>
                {s.mitre}
              </span>
            </div>

            <button
              onClick={() => runScenario(scenarioIdx)}
              disabled={running}
              style={{
                padding: "6px 14px",
        ...
        >
          Field names, query structures, and anomaly signatures reflect real AEGIS Shield detection logic.
          Each replay runs against a 90-day behavioral baseline model.
        </p>
      </div>
