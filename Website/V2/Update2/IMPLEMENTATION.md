...
- `investors.jsx` → `app/investors/page.jsx`
- `WhyNow.jsx`    → `components/WhyNow.jsx`
...
└── investors/
    └── page.jsx          ← investors.jsx (rename)

components/
└── WhyNow.jsx            ← drop directly here
```

---

## 1b. Adding WhyNow to Shield and Homepage

```jsx
// At the top of shield.jsx and homepage.jsx:
import WhyNow from "@/components/WhyNow";

// In shield/page.jsx — insert after the hero section closing tag:
<WhyNow context="ciso" />

// In homepage page.jsx — insert after the stats strip section:
<WhyNow context="market" />
```

The `context` prop controls copy framing:
- `"ciso"` — regulatory urgency, breach stats, defender language
- `"market"` — category creation, market timing, investor language
