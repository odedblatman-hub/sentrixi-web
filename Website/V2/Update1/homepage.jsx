"use client";
// app/page.jsx — Sentrixi Homepage Router
// Drop into: app/page.jsx (Next.js App Router)
// Fonts: add to app/layout.jsx → import { DM_Serif_Display, IBM_Plex_Mono } from "next/font/google"
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "2rem", alignItems: "center" }}>
          ...
          <a
            href="mailto:register@sentrixi.com"
            style={{
      ...
      >
        ...
        <div
          style={{
            ...
            height: "400px",
            background:
              "radial-gradient(ellipse, rgba(0,100,180,0.12) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          <ProductCard
            tier="TIER 1 · LAND"
            name="AEGIS Shield"
            description="AI-native behavioral detection embedded inside your database engine. Built for CISOs, CTOs, and VP R&D teams defending regulated environments."
            cta="Protect Your Database"
            href="/shield"
            accentColor="#00d4ff"
            glowColor="rgba(0,212,255,0.08)"
            tags={["Database Protection", "Behavioral AI", "Zero ETL"]}
          />
          <ProductCard
            tier="TIER 2 · EXPAND"
            name="AEGIS Sentinel"
            description="Full AI SIEM connecting to any datalake. Built for enterprise SOC teams and database vendors seeking to embed security as a native capability."
            cta="Explore Sentinel"
            href="/sentinel"
            accentColor="#f59e0b"
            glowColor="rgba(245,158,11,0.08)"
            tags={["Full AI SIEM", "Vendor Embed", "30+ AI Agents"]}
          />
        </div>
      ...
      >
        ...
        <a
          href="mailto:register@sentrixi.com"
          style={{ color: "#3a4f62", textDecoration: "none" }}
        >
          register@sentrixi.com
        </a>
      </footer>
    ...
    >
      <div
        style={{
          ...
          borderRadius: "12px",
          background: hovered ? glowColor : "rgba(8,16,30,0.6)",
      ...
      >
        ...
        >
          {cta}
          <span style={{ transition: "transform 0.2s", transform: hovered ? "translateX(4px)" : "none" }}>
            →
          </span>
        </div>
      </div>
...
function Stat({ value, label }) {
  return (
    <div>
      ...
      <div style={{ fontSize: "0.78rem", color: "#4a6a80", letterSpacing: "0.04em" }}>
        {label}
      </div>
    </div>
  );
